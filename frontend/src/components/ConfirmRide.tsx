...
const ConfirmRide = ({...props}: ConfirmRideProps) => {
  return (
    <div className="flex rounded-xl flex-col gap-5">
        ...
        <img className="size-42" src="https://www.uber-assets.com/image/upload/f_auto,q_auto:eco,c_fill,h_552,w_552/v1555367310/assets/30/51e602-10bb-4e65-b122-e394d80a9c47/original/Final_UberX.png" alt="" />
        </div>
