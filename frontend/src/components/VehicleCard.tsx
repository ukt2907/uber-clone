...
const VehicleCard = ({...props}: VehicleCardProps) => {
  return (
 <div onClick={()=>{props.setconfirmRidePanel(true), props.setvehiclePanel(false)}} className="gap-6 p-2.5 cursor-pointer active:border-black border  border-black/30 rounded-xl   grid grid-cols-4">
